...
(function(App) {
  ...
  App.Pattern = function() {
    ...
    function correctStepCount(desiredStepCount) {
      ...
      // Already correct?
      if (stepsPerChannel === desiredStepCount) {
        return;
      }
    ...
    function getChannelById(channelId) {
      ...
      if (typeof channelIndex[channelId] === 'undefined') {
        return false;
      }
    ...
    function removeChannel(channelId) {
      ...
      // Not found?
      if (typeof channelPatternIndex === 'undefined') {
        return;
      }
    ...
    function stepToggled(channelId, stepIndex, on) {
      ...
      if (typeof channel.steps[stepIndex] === 'undefined') {
        return;
      }
